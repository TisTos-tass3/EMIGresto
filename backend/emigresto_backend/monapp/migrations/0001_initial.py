...
>>>>>>> parent of df1d1cde ( ajustement fini)
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(blank=True, choices=[('M', 'Masculin'), ('F', 'Féminin')], help_text="Genre de l'utilisateur", max_length=2, null=True)),
